...
"""
Run HER on gymnasium robotics Fetch tasks:
$ python main.py --seed 1 --env-id FetchReach-v2 --track --wandb-project-name cleanrl
"""
import os
import random
import time
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        ...
        print(f"{info = }")
        print()
        print("Before flattening observation:")
